...
(function () {
  const DICT = {
    ...
    "foot.address":    { ja: "千葉県印西市大森2550-1-301 (羽田・成田空港 拠点)",
                          ...
                          zh: "千叶县印西市大森2550-1-301（羽田・成田机场基地）",
                          ko: "치바현 인자이시 오모리 2550-1-301 (하네다・나리타 공항 거점)" },
    ...
    "page.about.info.area.v":  { ja: "千葉県印西市大森2550-1-301 (羽田空港・成田空港 営業所)",
                                  en: "2550-1-301 Omori, Inzai-shi, Chiba (offices at Haneda and Narita Airports)",
                                  zh: "千叶县印西市大森2550-1-301（羽田机场・成田机场营业所）",
                                  ko: "치바현 인자이시 오모리 2550-1-301 (하네다・나리타 공항 영업소)" },
    ...
    "page.contact.f.pickupDate": { ja: "ご希望乗車日", en: "Pick-up Date", zh: "希望乘车日期", ko: "희망 승차일" },
    "page.contact.f.pickupTime": { ja: "ご希望時刻", en: "Pick-up Time", zh: "希望乘车时间", ko: "희망 승차 시각" },
    ...
    "reserve.err.f.date":      { ja: "ご希望乗車日を選択してください。", en: "Please select a pick-up date.", zh: "请选择乘车日期。", ko: "희망 승차일을 선택해 주세요." },
    "reserve.err.f.time":      { ja: "ご希望時刻を選択してください。", en: "Please select a pick-up time.", zh: "请选择乘车时间。", ko: "희망 승차 시각을 선택해 주세요." },
    "reserve.cap.ok":          { ja: "定員: 最大 {max} 名までご乗車いただけます。", en: "Capacity: seats up to {max} passengers.", zh: "可乘坐: 最多 {max} 人。", ko: "정원: 최대 {max}명까지 탑승 가능합니다." },
    "reserve.cap.over":        { ja: "ご希望の車両は最大 {max} 名までです。人数を減らすか、より大きい車両をお選びください。", en: "The selected vehicle seats up to {max} passengers. Please reduce the party size or choose a larger vehicle.", zh: "所选车型最多可乘坐 {max} 人。请减少人数或选择更大的车型。", ko: "선택하신 차량은 최대 {max}명까지 탑승 가능합니다. 인원을 줄이거나 더 큰 차량을 선택해 주세요." },
